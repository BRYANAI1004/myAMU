...
function compactLowerFilenamePart(raw) {
    return raw.trim().replace(/\s+/g, "").toLowerCase();
}
function alnumFilenamePart(raw) {
...
function buildFeedbackFilename(args) {
    ...
    if (section !== "unknown")
        return `feedback_${code}_${section}_${termYear}.csv`;
...
function formatSubmittedAt(v) {
    if (v == null || Number.isNaN(v.getTime()))
        return "";
...
export async function buildFeedbackCsvForSection(sectionId) {
...
//# sourceMappingURL=adminExportFeedbackCsvService.js.map