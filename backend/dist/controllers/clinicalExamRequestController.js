...
import { assignClinicalExamRequest, createStudentClinicalExamRequest, listAdminClinicalExamRequestsApi, listStudentClinicalExamRequestsApi, } from "../services/clinicalExamRequestService.js";
function devMessage(e) {
    return e instanceof Error ? e.message : typeof e === "string" ? e : String(e);
}
function parseQueryStudentId(req) {
 ...
 */
export async function postStudentClinicalExamRequestHandler(req, res) {
    try {
 ...
 */
export async function getStudentClinicalExamRequestsHandler(req, res) {
    try {
        const studentId = parseQueryStudentId(req);
        if (!studentId) {
            res.status(400).json({ error: "Query parameter studentId is required." });
 ...
 */
export async function getAdminClinicalExamRequestsHandler(_req, res) {
    try {
 ...
 */
export async function postAdminClinicalExamRequestAssignHandler(req, res) {
    try {
        ...
        if (Object.prototype.hasOwnProperty.call(body, "assignedExamDate")) {
            ...
            if (v === null)
                patch.assignedExamDate = null;
            else if (typeof v === "string")
                patch.assignedExamDate = v;
            else {
        ...
        if (Object.prototype.hasOwnProperty.call(body, "assignedExamTime")) {
            ...
            if (v === null)
                patch.assignedExamTime = null;
            else if (typeof v === "string")
                patch.assignedExamTime = v;
            else {
...
//# sourceMappingURL=clinicalExamRequestController.js.map